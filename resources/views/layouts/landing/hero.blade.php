        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
            <div class="md:col-span-7 flex flex-col gap-4">
                <h1 class="text-center md:text-start text-4xl font-bold md:text-6xl text-gray-100">
                    MyStock Good One Koi!
                </h1>
                <p class="text-sm md:text-lg text-center md:text-start text-gray-300">
                    Menyediakan informasi stok ikan Koi secara lengkap dan akurat, sehingga dapat mengelola inventaris yang lebih efisien dan permintaan barang dapat dilakukan kapan saja, di mana saja.
                </p>
            </div>
            <div class="hidden md:flex md:col-span-5">
                <img src="{{ asset('welcome.svg') }}" class="w-full" />
            </div>
        </div>
    </div>
</div>
